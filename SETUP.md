...
- Поставьте pyenv [по инструкции](https://github.com/pyenv/pyenv#installation)  
  ВНИМАНИЕ: Откройте инструкцию и сделайте всё что написано в ней.  
  При возникновении ошибок обратитесь к инструкции pyenv - она широкая и покрывает много случаев.
